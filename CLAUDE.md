...
- **Layout**: page sections in `components/sections/` (Hero, Services, Projects, HowItWorks, About, Contact), shared UI in `components/ui/` (Button, Navbar, Loader, CustomCursor).
